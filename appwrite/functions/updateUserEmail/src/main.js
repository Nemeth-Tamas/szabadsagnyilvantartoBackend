...
export default async ({ req, res, log, error }) => {
  ...
  try {
    ...
    if (!body || !body.submittingId || !body.userId || !body.newUserEmail) {
      throw new Error("submittingId|userId|newUserEmail is missing in the request body.");
    }
    ...
    await users.updateEmail(userId, newUserEmail);
